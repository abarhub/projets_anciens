...
et a les expliciter
si on definie la macro _NON_DEBUGAGE_ avant d'inclure ce fichier,
toutes ces macro n'auront aucun effet
(utile pour l'optimisation une fois que le programme n'a plus de bug)
*/
